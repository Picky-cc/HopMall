...
<body>
	...
	<div class="web-g-main">
		...
		<div data-commoncontent='true' class="content">
			<div class="position-map">
				<div class="pull-left">
					当前位置: <span class="item current">添加信托合同</span>
				</div>
					...
					<div class="panel panel-default feature-panel">
						<div class="panel-body">
							<div class="form-group demo2do-form-group">
								<label class="col-xs-2 control-label">信托产品代码</label>
								<div class="col-xs-3">
							...
							<div class="form-group demo2do-form-group row">
								...
								<div class="col-xs-3 pull-left">
									<input type="text" data-validate="required"
										name="financialContractName" id="financialContractName"
										class="form-control" />
								</div>
								...
								<div class="col-xs-2 pull-left">
									<select name="financialContractType"
										...
										<c:forEach var="item" items="${financialContractTypeList}">
											<option value="${item.ordinal}"><fmt:message
													key="${item.key}" /></option>
										</c:forEach>
									</select>
								</div>
							...
							<div class="form-group demo2do-form-group">
								...
								<div class="col-xs-4">
									<div class="input-group">
										<input type="date" class="form-control input-date"
											name="advaStartDate" id="advaStartDate" value="" />
									</div>
								</div>
								...
								<div class="col-xs-4">
									<div class="input-group">
										<input type="date" class="form-control input-date"
											name="thruDate" id="thruDate" value="" />
									</div>
								</div>
							</div>
							...
							<div class="form-group demo2do-form-group">
								...
								<div class="col-xs-4">
									<div class="input-group">
										<input type="number" id="loanOverdueStartDay" step="1"
											min="0" class="form-control" data-validate="number" /> <span
											class="input-group-addon">至</span> <input type="number"
											step="1" min="0" class="form-control" id="loanOverdueEndDay"
											data-validate="number" /> <span class="input-group-addon">自然日</span>
									</div>
								</div>
								...
								<div class="col-xs-4">
									<div class="input-group">
										...
										<span class="input-group-addon">自然日</span>
									</div>
								</div>
							</div>
							<div class="form-group demo2do-form-group">
								...
								<div class="col-xs-2">
									<div class="input-group">
										<input type="number" step="1" min="0" class="form-control"
											name="advaMatuterm" id="advaMatuterm" data-validate="number" /><span
			...
			<div class="text-center vertical-margin-20">
				...
				<button id="submit" type="submit"
					class="btn btn-success btn-shadow btn-shadow-success demo2do-btn">添加信托合约</button>
				&nbsp;&nbsp;&nbsp;&nbsp;
				<button type="button"
					class="btn btn-default btn-shadow btn-shadow-default demo2do-btn"
					data-dismiss="modal"><a href="javascript:window.history.go(-1);">取消添加</a></button>
	...
	<script type="text/javascript">
		$("#submit").click(function() {
			var financialContractNo = $("#financialContractNo").val();
			if (financialContractNo == "") {
				alert("请输入");
			}
			var financialContractName = $("#financialContractName").val();
			var companyId = $("#companyId").val();
			var appId = $("#appId").val();
			var financialContractType = $("#financialContractType").val();
			var loanOverdueStartDay = $("#loanOverdueStartDay").val();
			var loanOverdueEndDay = $("#loanOverdueEndDay").val();
			...
			$.ajax({
				type : 'POST',
				url : '${ctx}/financialContract/add-new-financialContract',
				data : {
