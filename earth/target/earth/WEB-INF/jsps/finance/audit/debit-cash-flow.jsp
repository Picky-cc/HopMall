...
<head>
  ...
  <%@ include file="/WEB-INF/jsps/finance/audit/include/exportYonYouData.jsp"%>
    ...
    <div data-commoncontent='true' class="content content-cashflow">
      ...
      <div class="scroller">
        <div class="lookup-params">
          <div class="inner clearfix">
            ...
            <span class="item hide">
              <select name="accountName" class="form-control real-value small account-info" id="accountName" autoquery="false">
            ...
            <span class="item">
              <select name="accountNo"class="form-control real-value small account-info" id="accountNo" autoquery="false">
        ...
        <div class="table-area">
          <table class="data-list data-list-cashflow" data-action="${ctx}/finance//cash-flow-audit/query?accountSide=debit" data-autoload="true">
            <thead>
              <tr>
                <th>银行流水</th>
                <th>付款方名称</th>
      ...
      <div class="operations">
          <div class="lt pull-left">
              ...
              <span class="item">
                  <button class="btn" id="exportYonYouVoucher">导出用友凭证数据</button>
              </span>
              <span class="item">
