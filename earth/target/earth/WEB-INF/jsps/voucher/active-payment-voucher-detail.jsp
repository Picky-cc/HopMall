		...
		<div class="content">
			<div class="scroller">
				<div class="position-map">
					<div class="pull-left">
			            当前位置:
			            <span class="item current">银行流水凭证详情</span>
					</div>
				...
				<div class="col-layout-detail">
					<div class="top">
						<div class="block">
							...
							<div class="bd">
								<div class="col">
									<p>合同编号：${detail.contract.contractNo}</p>
						...
						<div class="block">
							...
							<div class="bd">
								...
								<div class="col">
									...
									<p>原始图片凭证：
										<a href="${ctx}/voucher/active/detail/resource/${detailId}" class="voucherResource">下载</a>
									</p>
								</div>
								<div class="col">
					...
					<div class="block">
						<h5 class="hd">
							...
							<c:if test="${empty detail.cashFlow}">
								<button type="button" class="btn btn-default pull-right cash-flow-select" data-action="/contracts/exprot-loan-contract">流水选择</button>
							</c:if>
						</h5>
						<div class="bd">
				...
				<div class="table-layout-detail voucher-query-list">
					...
					<div class="block">
						...
						<div class="bd">
							<table class="data-list" data-action="${ctx}/voucher/business/detail/query" data-autoload="true">
								<thead>
									<tr>
										<th>还款编号</th>
										<th>贷款合同编号</th>
