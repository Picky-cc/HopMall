...
//            });
        ...
        _cancelAudit: function(options) {
            var that = this;
            $.post('./force-repay-apply', { repaymentBillUuid: options.repaymentBillUuid }, function (resp) {
    ...
    exports.OverdueRepaymentView = OverdueRepaymentView;
