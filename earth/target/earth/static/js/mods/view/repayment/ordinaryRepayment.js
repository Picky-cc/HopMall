define(function(require, exports, module) {
    ...
    var OrdinaryRepaymentView = TableContentView.extend({
        ...
        _cancelAudit: function(options) {
            var that = this;
            $.post('./flow-repay-apply', { repaymentBillUuid: options.repaymentBillUuid }, function (resp) {
    ...
    exports.OrdinaryRepaymentView = OrdinaryRepaymentView;
