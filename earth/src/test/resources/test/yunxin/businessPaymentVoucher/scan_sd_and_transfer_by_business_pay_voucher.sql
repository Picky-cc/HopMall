...
INSERT INTO `payment_channel` (`id`, `channel_name`, `user_name`, `user_password`, `merchant_id`, `cer_file_path`, `pfx_file_path`, `pfx_file_key`, `payment_channel_type`, `api_url`, `from_date`, `thru_date`) 
 ...
 -- contract1不引用
INSERT INTO `contract` (`id`, `uuid`,`unique_id`,`begin_date`, `contract_no`,`end_date`,`app_id`, `customer_id`, `house_id`,`actual_end_date`, `create_time`, `interest_rate`, `payment_day_in_month`, `payment_frequency`, `periods`, `repayment_way`, `total_amount`, `penalty_interest`,`active_version_no`) VALUES 
(1, 'contract_uuid_1','contract_unique_id_1','2015-10-19', 'DKHD-001', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 1000, 0.0001,1),
(7, 'contract_uuid_2','contract_unique_id_2','2015-10-19', 'DKHD-001', '2016-10-19', 1, 1, 1, NULL, '2015-10-19 13:34:35', 0.001, 1, 1, 12, 0, 1000, 0.0001,1);
...
('2', 'source_document_detail_uuid_2', 'source_document_uuid_1', 'contract_unique_id_2','repayment_plan_no_2', '500.00', '0', 'BUSINESS_PAYMENT_VOUCHER', 'bank_transaction_no_1', 'enum.voucher-type.pay', 'cash_flow_no_1', '0');
