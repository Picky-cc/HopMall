...
INSERT INTO `financial_contract` (`id`, `adva_matuterm`, `contract_no`, `app_id`, `company_id`,   `adva_repo_term`, `payment_channel_id`, `loan_overdue_start_day`, `loan_overdue_end_day`,`ledger_book_no`,`sys_create_penalty_flag`, `sys_create_statement_flag`,`financial_contract_uuid`) VALUES 
('1', 3, 'YX_AMT_001', 1, 1, 30,1,5,90,'ledger_book_no',1,1,'uuid');
