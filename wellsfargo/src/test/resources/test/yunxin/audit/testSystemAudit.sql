...
INSERT INTO `asset_set` (`id`, `guarantee_status`, `asset_fair_value`,`asset_initial_value`, `asset_recycle_date`, `asset_status`, `on_account_status`, `last_valuation_time`, `asset_uuid`, `create_time`, `last_modified_time`, `single_loan_contract_no`, `contract_id`, `actual_recycle_date`, `current_period`)
VALUES
	(1, 0, 2984.65,1000, '2016-05-01', 0, 1, '2016-04-07 21:49:04', '0d712307-a747-4a57-9fa5-792cf76c1a4c', '2016-04-06 16:43:47', '2016-04-07 21:49:04', 'test-contract-1-1', 1, NULL, 1),
	(2, 0, 2983.16,1000, '2016-05-01', 0, 1, NULL, '1676780d-15bf-4fe3-968c-62be2b02c3aa', '2016-04-06 16:43:47', NULL, 'test-contract-1-2', 1, NULL, 2);
...
INSERT INTO `contract_account` (`id`, `pay_ac_no`, `bankcard_type`, `contract_id`, `payer_name`, `bank`, `bind_id`, `id_card_num`, `bank_code`, `province`, `city`) VALUES 
('1', 'pay_ac_no_1', NULL, '1', 'payer_name_1', '中国邮政储蓄银行', NULL, 'ID_card1', '403', '安徽省', '亳州'),
('2', 'pay_ac_no_2', NULL, '2', 'payer_name_2', '中国邮政储蓄银行', NULL, 'ID_card12', '403', '江苏省', '淮安');
...
INSERT INTO `app_arrive_record` (`id`, `cash_flow_uid`,`amount`, `arrive_record_status`, `pay_ac_no`, `receive_ac_no`, `remark`, `serial_no`, `time`, `app_id`, `drcrf`, `pay_name`, `summary`, `vouh_no`, `operate_remark`,`issued_amount`,`audit_status`) VALUES
(1, 'cash_flow_uid_1','1200.60', 2, 'pay_ac_no_1', '1001300219000027827', '永业公寓28号604', '2015-03-30-22.39.56.930280', '2015-03-30 22:39:56', 2, '2', 'payer_name_1', '网转', '0', NULL,'0.00',0);
