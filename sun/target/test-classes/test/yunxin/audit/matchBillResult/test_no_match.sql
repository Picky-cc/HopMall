...
INSERT INTO `app_arrive_record` (`id`, `cash_flow_uid`,`amount`, `arrive_record_status`, `pay_ac_no`, `receive_ac_no`, `remark`, `serial_no`, `time`, `app_id`, `drcrf`, `pay_name`, `summary`, `vouh_no`, `detail_data`, `cash_flow_channel_type`, `transaction_type`, `partner_id`) VALUES 
('1', 'cash_flow_uuid_1','10.00', '0', 'account_new', 'receive_ac_no_1', NULL, 'serial_no_1', '2015-10-10 09:26:56', '1', '2', 'account_owner_name_new', '汇宁3号905房租', 'vouh_no_1', NULL, '0', '0', 'partner_id');
