...
INSERT INTO `financial_contract` (`id`, `adva_matuterm`, `contract_no`, `app_id`, `company_id`,`adva_repo_term`,`sys_overdue_deduct_flag`,`sys_normal_deduct_flag`) VALUES 
...
INSERT INTO `asset_set` (`id`, `asset_fair_value`, `asset_recycle_date`, `asset_status`, `asset_uuid`, `create_time`, `last_modified_time`, `single_loan_contract_no`, `contract_id`, `actual_recycle_date`,`version_no`,`active_status`) VALUES 
('1', 1010, Date(NOW()), 0, 'asset_uuid_1', '2015-10-19 13:34:35', '2015-10-19 13:34:35', 'DKHD-001-01', 1, '2015-10-19 13:34:35',1,0),
('2', 1000, Date(NOW()), 0, 'asset_uuid_2', '2015-10-19 13:34:35', '2015-10-19 13:34:35', 'DKHD-001-02', 1, '2015-10-19 13:34:35',1,0);
...
('2', Date(NOW()), 'DKHD-001-01-20160308', '2016-10-19 13:34:35',1010, '1','', '2016-10-19', 1, '2015-10-19',0,0,1),
('3', Date(NOW()), 'DKHD-001-02-20160308', '2016-10-19 13:34:35',1000, '1','', '2016-10-19', 1, '2015-10-19',0,0,1);
