 ...
 *
 */
public class ENTDISRdRtnPkg implements java.io.Serializable{
	 ...
	 * @param iRetMsg
	 */
	public ENTDISRdRtnPkg(String iSeqno, String orderNo, String payAccNo,
	...
	public String toString(){
		return String.format("支付方的账号(账号=%s,名称=%s)支付了金额(%s),附言(%s)",
				this.payAccNo,this.payAccNameCN,this.payAmt,this.postscript
				);
	}
}
