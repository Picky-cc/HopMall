...
function resetting_git_repository(){
	...
	echo `git remote -v` | grep -q "origin http://gitlab.5veda.net"
	...
	git remote rename origin upstream && git remote add origin 'http://gitlab.5veda.net/zjgsuwk/'$projectItem'.git'
